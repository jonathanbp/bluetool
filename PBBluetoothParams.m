...
#line 63 "PBBluetoothParams.rl"



#line 27 "PBBluetoothParams.m"
...
#line 43 "PBBluetoothParams.m"
	{
	 fsm->cs = params_start;
	}

#line 73 "PBBluetoothParams.rl"
}
...
#line 57 "PBBluetoothParams.m"
	...
	{
tr11:
#line 40 "PBBluetoothParams.rl"
	{ printf("help\n"); }
	goto st23;
tr17:
#line 41 "PBBluetoothParams.rl"
	{ printf("version\n"); }
	goto st23;
tr21:
#line 32 "PBBluetoothParams.rl"
	{
		if ( fsm->buflen < BUFLEN )
			fsm->buffer[fsm->buflen++] = 0;
	}
#line 44 "PBBluetoothParams.rl"
	{ printf("machine: \"%s\"\n", fsm->buffer); }
	goto st23;
tr25:
#line 32 "PBBluetoothParams.rl"
...
case 14:
	...
	goto tr18;
tr18:
#line 38 "PBBluetoothParams.rl"
	{ fsm->buflen = 0; }
#line 26 "PBBluetoothParams.rl"
	{
		if ( fsm->buflen < BUFLEN )
